...
// node_modules/@coze/api/dist/esm/index.js
var __WEBPACK_EXTERNAL_MODULE_os__ = __toESM(require_os());
var __WEBPACK_EXTERNAL_MODULE_crypto__ = __toESM(require_crypto());
var __WEBPACK_EXTERNAL_MODULE_jsonwebtoken__ = __toESM(require_jsonwebtoken());
...
var APIClient = class {
  ...
  async get(apiUrl, param, isStream2, options) {
    const queryString = Object.entries(param || {}).map((param2) => {
...
var getCrypto = () => {
  ...
  return __WEBPACK_EXTERNAL_MODULE_crypto__;
};
